...
internal fun ThemePalette.toSemanticColors(): TokenMonitorColors {
    return TokenMonitorColors(
...
val LocalTokenMonitorColors = staticCompositionLocalOf<TokenMonitorColors> {
