package io.coinbar.tokenmonitor.ui.navigation
...
import io.coinbar.tokenmonitor.ui.home.HomeRoute
import io.coinbar.tokenmonitor.ui.search.SearchRoute
import io.coinbar.tokenmonitor.ui.settings.OverlaySettingsRoute
import io.coinbar.tokenmonitor.ui.settings.SettingsRoute
...
@Composable
fun TokenMonitorNavHost(container: AppContainer) {
                ...
                NavigationBar(
                    ...
                    tabs.forEach { tab ->
                        ...
                        NavigationBarItem(
                            ...
                            colors = TokenMonitorComponentDefaults.navigationBarItemColors(),
                            icon = {
                                Icon(
