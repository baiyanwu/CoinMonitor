...
object AppConfigurationApplier {
    ...
    fun ProvideLocalizedResources(
        ...
        val layoutDirection = remember(localizedConfiguration) {
            if (TextUtils.getLayoutDirectionFromLocale(resolveLocale(localizedConfiguration)) == android.view.View.LAYOUT_DIRECTION_RTL) {
                LayoutDirection.Rtl
            } else {
                LayoutDirection.Ltr
            }
