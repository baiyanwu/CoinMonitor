...
class OverlayForegroundService : Service() {
    ...
    private fun scheduleRestart() {
        ...
        val intent = Intent(this, io.coinbar.tokenmonitor.boot.OverlayRestoreReceiver::class.java).apply {
    ...
    companion object {
        const val ACTION_START = "io.coinbar.tokenmonitor.action.START_OVERLAY"
        const val ACTION_STOP = "io.coinbar.tokenmonitor.action.STOP_OVERLAY"
        const val ACTION_REFRESH_NOW = "io.coinbar.tokenmonitor.action.REFRESH_NOW"
        const val ACTION_RESTART = "io.coinbar.tokenmonitor.action.RESTART_OVERLAY"
